<%@ Page Title="" Language="VB" MasterPageFile="~/basica.master" AutoEventWireup="false" CodeFile="lector.aspx.vb" Inherits="_Default" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="contenido" Runat="Server">
    ...
    <asp:ListView ID="ListView1" runat="server" DataKeyNames="id" DataSourceID="SqlDataSource1">
        <ItemTemplate>
            <asp:ImageButton ID="imgArticulo" runat="server" ImageUrl='<%# Eval("imagen") %>' Width="300px" height="300px" />
            <br />
            <br />
